...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        displayLocation = sharedPreferences.getBoolean(this.getString(R.string.pref_enable_location_key),
                Boolean.parseBoolean(this.getString(R.string.pref_enable_location_default)));
