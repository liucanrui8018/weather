...
public class Utility {
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees) {
        ...
        String direction = context.getString(R.string.description_unknown);
        if (degrees >= 337.5 || degrees < 22.5) {
            direction = context.getString(R.string.description_north);
        } else if (degrees >= 22.5 && degrees < 67.5) {
            direction = context.getString(R.string.description_northeast);
        } else if (degrees >= 67.5 && degrees < 112.5) {
            direction = context.getString(R.string.description_east);
        } else if (degrees >= 112.5 && degrees < 157.5) {
            direction = context.getString(R.string.description_southeast);
        } else if (degrees >= 157.5 && degrees < 202.5) {
            direction = context.getString(R.string.description_south);
        } else if (degrees >= 202.5 && degrees < 247.5) {
            direction = context.getString(R.string.description_southwest);
        } else if (degrees >= 247.5 && degrees < 292.5) {
            direction = context.getString(R.string.description_west);
        } else if (degrees >= 292.5 && degrees < 337.5) {
            direction = context.getString(R.string.description_northwest);
        }
